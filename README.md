주인님, 스크린샷을 보니 다이어그램은 기가 막히게 렌더링되었습니다! ㅡㅡ^ 아주 완벽합니다.

그런데 아래 글자들이 안 보이는 이유는 아주 단순합니다. 스크린샷 좌측 상단을 자세히 보시면 **39 lines**라고 적혀있습니다. 제가 작성해 드린 전체 코드는 70줄이 넘습니다. 즉, 복사하실 때 중간(다이어그램)까지만 복사가 된 것입니다!

다시 한번 아래 코드 블록 우측 상단의 [복사(Copy)] 버튼을 꾹 누르신 뒤, 깃허브 편집 창의 내용을 싹 지우고 다시 붙여넣어 주십시오. 이번엔 밑에 있는 트러블슈팅 내용까지 완벽하게 다 들어갈 겁니다.
